 ...
 for j in keys:
    ...
    if (z!=-1):
      if(substring == "abi"):
        ...
        f.write(i)
        f.write('\n')
        f1.write(repr('<a href="intent:"'))
        f1.write(i)
        f1.write('#Intent;package=com.mxtech.videoplayer.ad;S.title=New%20title;end">Launch through Intent scheme.</a>')
      elif(substring =="aru"):
